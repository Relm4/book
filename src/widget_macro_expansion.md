...
> The app we will write in this chapter is also available [here](https://github.com/Relm4/relm4/blob/main/examples/macro_test.rs). Run `cargo run --example macro_test` from the [example directory](https://github.com/Relm4/relm4/tree/main/examples) if you want to see the code in action.
